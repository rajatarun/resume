...
export default function StorePage() {
  return (
    <PageShell
      title="Workshops"
      intro="I coach engineering teams from first API call to production-grade AI systems. Each module below reflects a topic I love sharing knowledge on — grab the companion guide or reach out to run a session with your team."
    >
      {/* Stats bar */}
