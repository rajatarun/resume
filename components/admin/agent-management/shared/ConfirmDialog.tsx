...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      <div ref={dialogRef} className="w-full max-w-xl rounded-xl bg-white p-4 shadow-xl dark:bg-slate-900">
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
            type="button"
            className="focus-ring rounded bg-red-600 px-3 py-2 text-sm text-white disabled:opacity-50"
            onClick={onConfirm}
            disabled={busy}
            aria-busy={busy}
          >
