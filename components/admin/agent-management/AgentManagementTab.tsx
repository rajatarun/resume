...
// "Agents" now means the agents that run -- the ones defined in the team
// configs, with the system prompts that drive them. "Bedrock (legacy)" is the
// old tab, kept because Bedrock Agents Classic resources still exist in the
// account and someone has to be able to see them; nothing invokes them.
const SECTIONS = ["Agents", "Teams", "Roles", "Departments", "Bedrock (legacy)", "Observability"] as const;
