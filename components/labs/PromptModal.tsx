    ...
    >
      ...
      >
        <div className="mb-3 flex items-start justify-between gap-3">
          <h2 id="prompt-modal-title" className="text-lg font-semibold text-slate-900 dark:text-white">
            {agentName} prompt
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="mt-3 flex justify-end">
          <button
            onClick={copyPrompt}
            className="focus-ring rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
          >
            Copy prompt
          </button>
        </div>
